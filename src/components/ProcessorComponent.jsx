...
import { createProcessor, getProcessor, updateProcessor } from '../services/ProcessorService';
...
function ProcessorComponent() {
  ...
  function saveProcessor(e) {
    e.preventDefault();

    if (validateForm()) {
      const processor = { manufacturer, name, bought_price, selling_price, quantity_in_stock };
      console.log(processor);

      if (id) {
        updateProcessor(id, processor)
          .then((response) => {
        ...
        <div className='card col-md-6 offset-md-3 offset-md-3'>
          ...
          <div className='card-body'>
            <form>
              ...
              <button className='btn btn-success' onClick={saveProcessor}>Підтвердити</button>
              <br/><br/>
