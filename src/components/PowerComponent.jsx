...
import { createPower, getPower, updatePower } from '../services/PowerService';
...
function PowerComponent() {
  ...
  function savePower(e) {
    ...
    if (validateForm()) {
      const power = { manufacturer, name, bought_price, selling_price, quantity_in_stock };
      console.log(power);

      if (id) {
        updatePower(id, power).then((response) => {
        ...
        createPower(power).then((response) => {
          console.log(response.data);
          navigate('/powerUnits');
        }).catch(error => {
          console.error(error);
        ...
        <div className='card col-md-6 offset-md-3 offset-md-3'>
          ...
          <div className='card-body'>
            <form>
              ...
              <button className='btn btn-success' onClick={savePower}>Підтвердити</button>
              <br/><br/>
