...
import { createPrinter, getPrinter, updatePrinter } from '../services/PrinterService';
...
function PrinterComponent() {
  ...
  function savePrinter(e) {
    ...
    if (validateForm()) {
      const printer = { manufacturer, name, bought_price, selling_price, quantity_in_stock };
      console.log(printer);

      if (id) {
        updatePrinter(id, printer).then((response) => {
        ...
        createPrinter(printer).then((response) => {
          console.log(response.data);
          navigate('/printers');
        }).catch(error => {
          console.error(error);
        ...
        <div className='card col-md-6 offset-md-3 offset-md-3'>
          ...
          <div className='card-body'>
            <form>
              ...
              <button className='btn btn-success' onClick={savePrinter}>Підтвердити</button>
              <br/><br/>
