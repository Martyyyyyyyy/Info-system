...
import { createTablet, getTablet, updateTablet } from '../services/TabletService';
...
function TabletComponent() {
  ...
  function saveTablet(e) {
    e.preventDefault();

    if (validateForm()) {
      const tablet = { manufacturer, name, bought_price, selling_price, quantity_in_stock };
      console.log(tablet);
        ...
        <div className='card col-md-6 offset-md-3 offset-md-3'>
          ...
          <div className='card-body'>
            <form>
              ...
              <button className='btn btn-success' onClick={saveTablet}>Підтвердити</button>
              <br/><br/>
