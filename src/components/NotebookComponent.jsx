...
import { createNotebook, getNotebook, updateNotebook } from '../services/NotebookService';
...
function NotebookComponent() {
  ...
  function saveNotebook(e) {
    ...
    if (validateForm()) {
      const notebook = { manufacturer, name, bought_price, selling_price, quantity_in_stock };
      console.log(notebook);

      if (id) {
        updateNotebook(id, notebook).then((response) => {
        ...
        createNotebook(notebook).then((response) => {
          console.log(response.data);
          navigate('/notebooks');
        }).catch(error => {
          console.error(error);
        ...
        <div className='card col-md-6 offset-md-3 offset-md-3'>
          ...
          <div className='card-body'>
            <form>
              ...
              <button className='btn btn-success' onClick={saveNotebook}>Підтвердити</button>
              <br/><br/>
